...
?>
    <nav>
        <ul class="pagination">
            ...
            <?php else: ?>
                <li><a href="<?php echo get_pagenum_link($paged-1); ?>" aria-label="Previous"><i class="fa fa-caret-left"></i></a></li>
            <?php endif; ?>
            ...
            <?php else: ?>
                <li><a href="<?php echo get_pagenum_link($paged+1); ?>" aria-label="Next"><i class="fa fa-caret-right"></i></a></li>
            <?php endif; ?>
        </ul>
    </nav>
<?php
